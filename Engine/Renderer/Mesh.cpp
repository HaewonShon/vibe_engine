...
Mesh Mesh::CreateCube(ID3D12Device* device, ID3D12GraphicsCommandList* cmdList)
{
    ...
    std::vector<Vertex> verts = {
        // Front  (z=+0.5) -- red
        { { -0.5f, -0.5f,  0.5f }, { 0.9f, 0.2f, 0.2f, 1.f }, { 0.f, 1.f } },
        { {  0.5f, -0.5f,  0.5f }, { 0.9f, 0.2f, 0.2f, 1.f }, { 1.f, 1.f } },
        { {  0.5f,  0.5f,  0.5f }, { 1.0f, 0.4f, 0.4f, 1.f }, { 1.f, 0.f } },
        { { -0.5f,  0.5f,  0.5f }, { 1.0f, 0.4f, 0.4f, 1.f }, { 0.f, 0.f } },
        // Back   (z=-0.5) -- blue
        { {  0.5f, -0.5f, -0.5f }, { 0.2f, 0.2f, 0.9f, 1.f }, { 0.f, 1.f } },
        { { -0.5f, -0.5f, -0.5f }, { 0.2f, 0.2f, 0.9f, 1.f }, { 1.f, 1.f } },
        { { -0.5f,  0.5f, -0.5f }, { 0.4f, 0.4f, 1.0f, 1.f }, { 1.f, 0.f } },
        { {  0.5f,  0.5f, -0.5f }, { 0.4f, 0.4f, 1.0f, 1.f }, { 0.f, 0.f } },
        // Left   (x=-0.5) -- green
        { { -0.5f, -0.5f, -0.5f }, { 0.2f, 0.9f, 0.2f, 1.f }, { 0.f, 1.f } },
        { { -0.5f, -0.5f,  0.5f }, { 0.2f, 0.9f, 0.2f, 1.f }, { 1.f, 1.f } },
        { { -0.5f,  0.5f,  0.5f }, { 0.4f, 1.0f, 0.4f, 1.f }, { 1.f, 0.f } },
        { { -0.5f,  0.5f, -0.5f }, { 0.4f, 1.0f, 0.4f, 1.f }, { 0.f, 0.f } },
        // Right  (x=+0.5) -- yellow
        { {  0.5f, -0.5f,  0.5f }, { 0.9f, 0.9f, 0.1f, 1.f }, { 0.f, 1.f } },
        { {  0.5f, -0.5f, -0.5f }, { 0.9f, 0.9f, 0.1f, 1.f }, { 1.f, 1.f } },
        { {  0.5f,  0.5f, -0.5f }, { 1.0f, 1.0f, 0.3f, 1.f }, { 1.f, 0.f } },
        { {  0.5f,  0.5f,  0.5f }, { 1.0f, 1.0f, 0.3f, 1.f }, { 0.f, 0.f } },
        // Top    (y=+0.5) -- magenta
        { { -0.5f,  0.5f,  0.5f }, { 0.9f, 0.2f, 0.9f, 1.f }, { 0.f, 1.f } },
        { {  0.5f,  0.5f,  0.5f }, { 0.9f, 0.2f, 0.9f, 1.f }, { 1.f, 1.f } },
        { {  0.5f,  0.5f, -0.5f }, { 1.0f, 0.4f, 1.0f, 1.f }, { 1.f, 0.f } },
        { { -0.5f,  0.5f, -0.5f }, { 1.0f, 0.4f, 1.0f, 1.f }, { 0.f, 0.f } },
        // Bottom (y=-0.5) -- cyan
        { { -0.5f, -0.5f, -0.5f }, { 0.2f, 0.9f, 0.9f, 1.f }, { 0.f, 1.f } },
        { {  0.5f, -0.5f, -0.5f }, { 0.2f, 0.9f, 0.9f, 1.f }, { 1.f, 1.f } },
        { {  0.5f, -0.5f,  0.5f }, { 0.4f, 1.0f, 1.0f, 1.f }, { 1.f, 0.f } },
        { { -0.5f, -0.5f,  0.5f }, { 0.4f, 1.0f, 1.0f, 1.f }, { 0.f, 0.f } },
    };
